...
<div id="page-wrapper" >
    <div id="page-inner">
        <div class="row">
    		<?php
			// Validasi inputan
			echo validation_errors('<div class="alert alert-warning center">','</div>');
			//open form
			echo form_open_multipart(base_url('daftar_santri/tambah'));
			?>
			<div class="col-md-6 col-sm-6">
                <div class="panel panel-primary">
					...
					<!-- field Pendidikan -->
						<div class="form-group form-group-lg">
							<label>Pendidikan formal yang dijalani</label><br/>
            ...
            <div class="col-md-6 col-sm-6">
                <div class="panel panel-primary">
					...
					<!-- field no kontak -->
                        <div class="form-group form-group-lg">
							<label>No kontak <sup>(HP / Telepon / Fax)</sup></label>

...
<div class="modal fade" id="myModal<?php echo $site->id_site ?>" tabindex="-1" role="dialog" 
aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            Apakah Anda yakin ingin menghapus data site?
        	</div>
    	<div class="modal-footer">
        	<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
           	<a href="<?php echo base_url('admin/site/delete/'.$site->id_site) ?>" class="btn btn-primary">
